...
static void gpio_isr_handler(void *arg)
{
	...
	xSemaphoreGiveFromISR(xBinarySemaphore, signed BaseType_t *pxHigherPriorityTaskWoken)
}
...
void app_main(void)
{
	...
	gpio_isr_handler_remove(GPIO_INPUT_PIN_SEL);
	...
	while (1) {
		...
		gpio_set_level(GPIO_OUTPUT_PIN_SEL, cnt % 2);
	}
}
